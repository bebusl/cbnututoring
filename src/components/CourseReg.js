    ...
    <div>
      <form onSubmit={handleSubmit} encType="multipart/form-data">
        <ul>
          ...
          <li>교과목명 
          <input type="text" name="courseName" onChange={handleChange} ></input>
          </li>
          
          <li>담당교수
          <input type="text" name="professorName" onChange={handleChange}></input>
          ...
          <li>튜터학번
          <input type="text" name="tutorNumber" onChange={handleChange}></input>
          ...
          <li>운영계획서
            <input type="file" name = "file" accept=".pdf,.hwp" onChange={handleFileChange}/>
          </li>
